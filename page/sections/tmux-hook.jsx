...
function TmuxHookSection({ accent }) {
  ...
  const tmuxHookLines = [
    ...
    ['    ', [TK.kw, 'if'], [TK.op, ' (!'], [TK.ty, 'process'], [TK.op, '.env.'], [TK.prop, 'TMUX'], [TK.op, ') '], [TK.kw, 'return'], [TK.op, ' event.'], [TK.fn, 'skip'], [TK.op, '()']],
    ['    ', [TK.kw, 'const'], [TK.fn, ' id'], [TK.op, ' = '], [TK.fn, 'getWindowId'], [TK.op, '()']],
    ['    ', [TK.kw, 'if'], [TK.op, ' (!id) '], [TK.kw, 'return'], [TK.op, ' event.'], [TK.fn, 'skip'], [TK.op, '()']],
    ['    w = id'],
    ['  ', [TK.op, '},']],
    '',
    ...
    ['    ', [TK.op, '}']],
    ['    ', [TK.kw, 'return'], [TK.op, ' ctx.'], [TK.fn, 'skip'], [TK.op, '()']],
    ['  ', [TK.op, '},']],
    '',
    ['  ', [TK.fn, 'UserPromptSubmit'], [TK.op, '(ctx) { '], [TK.fn, 'resetWindow'], [TK.op, '(w); '], [TK.kw, 'return'], [TK.op, ' ctx.'], [TK.fn, 'skip'], [TK.op, '() },']],
    ['  ', [TK.fn, 'PostToolUse'], [TK.op, '(ctx)      { '], [TK.fn, 'resetWindow'], [TK.op, '(w); '], [TK.kw, 'return'], [TK.op, ' ctx.'], [TK.fn, 'skip'], [TK.op, '() },']],
    ['  ', [TK.fn, 'SessionStart'], [TK.op, '(ctx)     { '], [TK.fn, 'resetWindow'], [TK.op, '(w); '], [TK.kw, 'return'], [TK.op, ' ctx.'], [TK.fn, 'skip'], [TK.op, '() },']],
    [[TK.op, '}']],
  ];
  ...
  const pkgHookLines = [
    ...
    ['    ', [TK.kw, 'if'], [TK.op, ' (ctx.'], [TK.prop, 'toolName'], [TK.op, ' !== '], [TK.str, "'Bash'"], [TK.op, ') '], [TK.kw, 'return'], [TK.op, ' ctx.'], [TK.fn, 'skip'], [TK.op, '()']],
    '',
    ...
    ['    ', [TK.kw, 'return'], [TK.op, ' ctx.'], [TK.fn, 'block'], [TK.op, '({']],
  ...
  const mvHookLines = [
    ...
    ['    ', [TK.kw, 'if'], [TK.op, ' (!'], [TK.fn, 'startsWithMv'], [TK.op, '(cmd)) '], [TK.kw, 'return'], [TK.op, ' ctx.'], [TK.fn, 'skip'], [TK.op, '()']],
    '',
    ['    ', [TK.kw, 'const'], [TK.fn, ' rewritten'], [TK.op, ' = cmd.'], [TK.fn, 'replace'], [TK.op, '(/^\\s*mv\\b/, '], [TK.str, "'git mv'"], [TK.op, ')']],
    ['    ', [TK.kw, 'return'], [TK.op, ' ctx.'], [TK.fn, 'allow'], [TK.op, '({']],
    ['      ', [TK.prop, 'updatedInput'], [TK.op, ': { '], [TK.prop, 'command'], [TK.op, ': rewritten },']],
    ['      ', [TK.prop, 'injectContext'], [TK.op, ': '], [TK.str, "'rewrote mv → git mv'"], [TK.op, ',']],
    ['    ', [TK.op, '})']],
    ['  ', [TK.op, '},']],
    [[TK.op, '}']],
  ];
