...
// ---------- Ordering: parallel fan-out + sequential tail ----------
  ...
  const captures = [
    ...
    },
    {
      ...
      lines: [
        ...
        [['d', '  Ran 1 bash command']],
        null,
        [['a', '● '], ['f', 'The hook '], ['mono', 'broken-dev-hook'], ['f', ' errored with a SyntaxError, but it was configured as '], ['mono', 'onError: trace'], ['f', ', so it did not block the action. The command '], ['mono', 'debug-me'], ['f', ' was not found on the PATH.']],
      ],
      annotations: [
...
Object.assign(window, {
  ProblemSection, HookInActionSection, HookAnatomySection, ConfigSection, OrderingSection, InstallSection,
