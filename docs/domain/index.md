...
| Document | Path | Description |
|----------|------|-------------|
| Codex Native Testing | `testing/codex-native.md` | Synthetic fixture provenance, native evidence limits, retained CLI prerequisites and isolated smoke commands |
