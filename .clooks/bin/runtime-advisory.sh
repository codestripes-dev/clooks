...
message='[clooks] This project requires Clooks '"$CLOOKS_REQUIRED_RUNTIME"' or newer; installed: '"$installed"'. Run '"$setup"', or update Clooks using its original installation method.'
