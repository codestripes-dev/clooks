...
import { CLAUDE_CODE_EVENTS, INJECTABLE_EVENTS, isEventName } from './config/constants.js'
import {
  readFailures,
  writeFailures,
  recordFailure,
 ...
 * Injecting deps via an optional parameter keeps production unchanged
 * (defaultDeps wires the real implementations) while letting tests swap
 * in fakes without global side effects.
 */
